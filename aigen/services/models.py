...
class AgentConfiguration(BaseModel):
    ...
    agent_type: str = Field(..., description="Unique identifier for this agent type")
    ...
    model: str = Field("gpt-4o", description="Model to use for the agent")
    ...
    handoffs: List[str] = Field(
        default_factory=list, description="Agents this agent can hand off to"
    )
    output_type: Optional[str] = Field(
        None, description="Structured output type specification"
    )
