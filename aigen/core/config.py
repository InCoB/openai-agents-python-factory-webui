"""
Configuration Module - Manages configuration settings for the AI Agent Framework.

This module provides facilities for loading, storing, and accessing configuration
settings from various sources, including files, environment variables, and direct
setting. It supports hierarchical configuration, defaults, and validation.
"""
...
class ConfigManager:
    ...
    def _load_defaults(self) -> None:
        ...
        self.config_data = {
            ...
            "workflow": {"max_turns": 80, "max_retries": 3, "retry_delay": 5},
            "ui": {"gradio_port": 7860, "gradio_host": "0.0.0.0"},
        }
    ...
    def _update_config_recursive(
        self, source_dict: Dict[str, Any], source_name: str, prefix: str = ""
    ) -> None:
