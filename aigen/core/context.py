"""
Context Module - Defines the execution context for agents and workflows.

This module provides a Context class that serves as a communication and data sharing
mechanism between different components of the framework. It holds state information,
execution history, and provides structured access to the current execution environment.
"""
...
class Context(Generic[T]):
    ...
    def get_user_metadata(self, key: str, default: Any = None) -> Any:
        """
        Get user-defined metadata from the context.
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        try:
            ...
            # Handle serialization errors by falling back to string representation
            data_dict = str(self._data)
            logger.debug(f"Error serializing context data: {e}")
        ...
        return {
            ...
            "intermediate_outputs": {
                k: str(v) for k, v in self._intermediate_outputs.items()
            },
